...
targetOffsetMaxValue = 50;
targetOffset = vec2(
	random_range(-targetOffsetMaxValue, targetOffsetMaxValue),
	random_range(-targetOffsetMaxValue, targetOffsetMaxValue)
);

alarm[0] = random_range(1.00, 6.00) * 60;
alarm[1] = random_range(1.00, 15.00);
...
handleMovement = function() {
	...
	// Follow target
	if (target != noone) {
		direction = point_direction(x, y, target.x + targetOffset.x, target.y + targetOffset.y) + directionOffsetValue;
