...
// Probably my stupid way of doing this, i know i could use ds maps or whatever the fuck
// but this works and im fine with it 8===D

globalvar TranslationData;
TranslationData = [];


#region English

TranslationData[LANGUAGE.English, 0] = "English";
TranslationData[LANGUAGE.English, 1] = "Spaceship menu";
TranslationData[LANGUAGE.English, 2] = "Components";
TranslationData[LANGUAGE.English, 3] = "Inventory";
TranslationData[LANGUAGE.English, 4] = "Health";
TranslationData[LANGUAGE.English, 5] = "Settings";
TranslationData[LANGUAGE.English, 6] = "true";
TranslationData[LANGUAGE.English, 7] = "false";
TranslationData[LANGUAGE.English, 8] = "Sun Prox. Alert";
TranslationData[LANGUAGE.English, 9] = "Return";
TranslationData[LANGUAGE.English, 10] = "empty";
TranslationData[LANGUAGE.English, 11] = "Glow Effect";
TranslationData[LANGUAGE.English, 12] = "Audio Settings";
TranslationData[LANGUAGE.English, 13] = "Paused";
TranslationData[LANGUAGE.English, 14] = "Resume";
TranslationData[LANGUAGE.English, 15] = "Master";
TranslationData[LANGUAGE.English, 16] = "Music";
